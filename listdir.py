...
class DirList(object):
    ...
    def __init__(self, initdir=None):
        self.top = Tk()
        self.label = Label(self.top, text='Directory Listener v1.1')
        self.label.pack()
        ...
        self.dirs.bind('<Double-1>-1', self.setDirAndGo)
        ...
        self.quit = Button(self.btm, text='QUIT', command=self.top.quit, activeforeground='white',
    ...
    def setDirAndGo(self, ev=None):
        ...
        check = self.dir.get(self.dirs.curselection())
        if not check:
            check = os.curdir
        self.cwd.set(check)
        self.doLS()

    def doLS(self, ec=None):
        error = ''
        tdir = self.cwd.get()
